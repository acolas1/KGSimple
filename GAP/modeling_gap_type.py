...
class GAPPretrain(BartForConditionalGeneration):
    ...
    def forward(self, input_ids, attention_mask=None, encoder_outputs=None, encoder_label=None,
            ...
            node_length=None, adj_matrix=None, decoder_whole_ids=None, word_length=None,
        ...
        # corrupted graph + complete text --> complete graph
        if is_training:
