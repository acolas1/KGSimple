...
#TODO: MASKER for saliency model

# Pre-training coverage dataset (wikidata)
class WikidataDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        node_length_ae, edge_length_ae = max(input_node_ids_ae) + 1, max(input_edge_ids_ae) + 1
        ...
        return decoder_label_ids, decoder_attn_mask, input_ids_ae, attn_mask_ae, \
               encoder_label_ids, input_node_ids_ae, input_edge_ids_ae, \
